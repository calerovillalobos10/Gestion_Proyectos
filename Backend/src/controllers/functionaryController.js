...
export default class FunctionaryController{
    ...
    verifyAttributesFunctionary = (dataLogin) => {
        ...
        const sexoRes = dataLogin.getSexo,
              departmentoRes = dataLogin.getDepartment,
              tipoFuncionarioRes = dataLogin.getTipoFuncionario,
              nombreRes = dataLogin.getNombre,
              apellido_1Res = dataLogin.getApellido_1,
              apellido_2Res = dataLogin.getApellido_2,
              fechaNacimientoRes = dataLogin.getFechaNacimiento,
              correoRes = dataLogin.getCorreo,
              contraseniaRes = dataLogin.getContrasenia,
              urlFotoRes = dataLogin.getUrlFoto,
              estadoRes = dataLogin.getEstado;
        ...
        let verifySexo = ( sexoRes != null && this.validacionController.verifySpecialCharacters(parseInt(sexoRes, 10)) && this.validacionController.verifyMinSize(parseInt(sexoRes, 10), 1) && this.validacionController.verifyNumber(parseInt(sexoRes, 10)) ) ? true : false,
            ...
            verifyDepartmento = ( departmentoRes != null && this.validacionController.verifySpecialCharacters(parseInt(departmentoRes, 10)) && this.validacionController.verifyMinSize(parseInt(departmentoRes, 10), 1) && this.validacionController.verifyNumber(parseInt(departmentoRes, 10)) ) ? true : false,
        
            verifyTipoFuncionario = ( tipoFuncionarioRes != null && this.validacionController.verifySpecialCharacters(parseInt(tipoFuncionarioRes, 10)) && this.validacionController.verifyMinSize(parseInt(tipoFuncionarioRes, 10), 1) && this.validacionController.verifyNumber(parseInt(tipoFuncionarioRes, 10)) ) ? true : false,
        
            verifyNombre = ( nombreRes != null && this.validacionController.verifySpecialCharacters(nombreRes) && this.validacionController.verifyMinSize(nombreRes, 3) && this.validacionController.verifyMaxSize(nombreRes, 15) ) ? true : false,
        
            verifyApellido_1 = ( apellido_1Res != null && this.validacionController.verifySpecialCharacters(apellido_1Res) && this.validacionController.verifyMinSize(apellido_1Res, 3) && this.validacionController.verifyMaxSize(apellido_1Res, 15) ) ? true : false,
        
            verifyApellido_2 = ( apellido_2Res != null && this.validacionController.verifySpecialCharacters(apellido_2Res) && this.validacionController.verifyMinSize(apellido_2Res, 3) && this.validacionController.verifyMaxSize(apellido_2Res, 15) ) ? true : false,
        
            verifyFechaNacimiento = ( fechaNacimientoRes != null && this.validacionController.verifySpecialCharacters(fechaNacimientoRes) && this.validacionController.verifyDate(fechaNacimientoRes) ) ? true : false,
        
            verifyCorreo = ( correoRes != null && this.validacionController.verifyEmail(correoRes) && this.validacionController.verifyMinSize(correoRes, 12) && this.validacionController.verifyMaxSize(correoRes, 50) ) ? true : false,
        
            verifyContrasenia = ( contraseniaRes != null && this.validacionController.verifySpecialCharacters(contraseniaRes) && this.validacionController.verifyMinSize(contraseniaRes, 8) && this.validacionController.verifyMaxSize(contraseniaRes, 16) ) ? true : false,
        
            verifyUrlFoto = ( urlFotoRes != null && this.validacionController.verifySpecialCharacters(urlFotoRes) && this.validacionController.verifyMinSize(urlFotoRes, 5) && this.validacionController.verifyMaxSize(urlFotoRes, 180) ) ? true : false,
        
            verifyEstado = ( estadoRes != null && this.validacionController.verifySpecialCharacters(estadoRes) && this.validacionController.verifyMinSize(estadoRes, 1) && this.validacionController.verifyNumber(estadoRes) ) ? true : false;
